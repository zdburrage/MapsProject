    ...
    self.destinations().forEach(function(d) {
        ...
        $.ajax({
            url: 'https://api.foursquare.com/v2/venues/' + d.fourSquareId() +
                '?client_id=ZT2KZ3GBVHOTV4CLUDMOM11B333IIJ2O2V4Z0HTEXT0C1PWF&client_secret=AO4UA0ZBGNXVJNPZXB5J3QNVO5BRHMNE3CJACCMXSCXHK5Y1&v=20171226',
            dataType: 'json',
...
function googleFail() {
  window.alert("The requested resource is not available");
}
